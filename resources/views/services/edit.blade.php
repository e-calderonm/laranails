                    ...
                    <form method="POST" action="{{ route('services.update', $service) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="category" id="category"
                                ...
                                <option value="UÑAS" {{ $service->category == 'UÑAS' ? 'selected' : '' }}>UÑAS</option>
                                <option value="CEJAS, PESTAÑAS Y OTROS" {{ $service->category == 'CEJAS, PESTAÑAS Y OTROS' ? 'selected' : '' }}>CEJAS, PESTAÑAS Y OTROS</option>
                                <option value="DEPILACIÓN" {{ $service->category == 'DEPILACIÓN' ? 'selected' : '' }}>DEPILACIÓN</option>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full rounded-xl border-rose-200 focus:border-rose-500 focus:ring-rose-500 shadow-sm">{{ old('description', $service->description) }}</textarea>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4 mt-4">
                            ...
                            <button type="submit"
                                class="bg-rose-500 hover:bg-rose-600 text-white font-bold py-3 px-6 rounded-xl shadow-md transition transform hover:scale-105">
                                Guardar Cambios
                            </button>
                        </div>
